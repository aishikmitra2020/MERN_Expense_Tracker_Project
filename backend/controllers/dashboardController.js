...
exports.getDashboardData = async (req, res) => {
    try {
        ...
        const userObjectId = new Types.ObjectId(String(userId)); // Converts it into a Mongoose ObjectId to be used in DB queries.
        ...
        // Get some transactions for the last 60 days
